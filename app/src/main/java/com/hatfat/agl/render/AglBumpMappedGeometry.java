...
public class AglBumpMappedGeometry implements AglRenderable {
    ...
    public AglBumpMappedGeometry(float vertices[], int numVertices, int elements[], int numElements,
            AglTexture texture, AglTexture normalMap) {
        ...
        GLES20.glBufferData(GLES20.GL_ARRAY_BUFFER, AglDef.SIZEOF_FLOAT * numVertices * 14, vertexBuffer, GLES20.GL_STATIC_DRAW);
...
//          vec3 bi tangents
        ...
        GLES20.glVertexAttribPointer(posAttrib, 3, GLES20.GL_FLOAT, false, 14 * AglDef.SIZEOF_FLOAT,
                0);

        int textureAttrib = GLES20.glGetAttribLocation(shaderProgram, "texture");
        GLES20.glEnableVertexAttribArray(textureAttrib);
        GLES20.glVertexAttribPointer(textureAttrib, 2, GLES20.GL_FLOAT, false, 14 * AglDef.SIZEOF_FLOAT, 3 * AglDef.SIZEOF_FLOAT);

        int normalAttrib = GLES20.glGetAttribLocation(shaderProgram, "normal");
        GLES20.glEnableVertexAttribArray(normalAttrib);
        GLES20.glVertexAttribPointer(normalAttrib, 3, GLES20.GL_FLOAT, false, 14 * AglDef.SIZEOF_FLOAT, 5 * AglDef.SIZEOF_FLOAT);
